...
AFPSCharacter::AFPSCharacter()
{
	...
	NoiseEmitterComp = CreateDefaultSubobject<UPawnNoiseEmitterComponent>(TEXT("CharacterNoiseEmitter"));
}
...
{
	// typically used for sanity checks, check for cheating / timers
	return true;
}
...
void AFPSCharacter::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	// only gets sent to controlling client
